<?php
/**
 * The template for displaying a list of the COMMUNITY current page's child pages. NOTE: This pulls from the main navigation menu so that the list is organized the same way as the navigation.
 */
...
if( empty($hide_block) ) : ?>
    ...
    <div class="container">
        ...
        <?php // Main Nav Menu
        if( have_rows('main_menu_item', 'community_' . $terms_string[0]) ):
