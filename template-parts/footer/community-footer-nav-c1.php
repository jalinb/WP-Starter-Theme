<?php
/**
 * The template for displaying the footer column one navigation
 */
...
// Main Footer Menu
if( have_rows('footer_menu_item', 'community_' . $terms_string[0]) ): // Repeater
    while ( have_rows('footer_menu_item', 'community_' . $terms_string[0]) ) : the_row();
